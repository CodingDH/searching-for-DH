...
if __name__ == '__main__':
    ...
    users_starred_df, user_df = get_user_users_activities(original_owners,user_users_output_path, users_output_path, get_url_field, load_existing_files, overwrite_existing_temp_files)